...
> Development notice: the `modernisation` branch is not an official release.
> Its current release gate and tested matrix are documented in
> `RELEASE-READINESS.md`; use a staging backup and follow `UPGRADE.md`.
